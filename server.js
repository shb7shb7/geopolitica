...
const PERIOD_DESCS = [
  ...
  "Catastrophe mondiale. ⚠️ Attention : la période 4 vous réservera une SURPRISE — l'indice ci-dessous annonce un prix, mais le vrai événement sera un choix stratégique. 2 actions.",
